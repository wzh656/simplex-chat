package com.grayheterotopia.app.model
...
import com.grayheterotopia.app.*
import com.grayheterotopia.app.TAG
...
object NtfManager {
  const val MessageChannel: String = "com.grayheterotopia.app.MESSAGE_NOTIFICATION"
  const val MessageGroup: String = "com.grayheterotopia.app.MESSAGE_NOTIFICATION"
  const val OpenChatAction: String = "com.grayheterotopia.app.OPEN_CHAT"
  const val ShowChatsAction: String = "com.grayheterotopia.app.SHOW_CHATS"
  ...
  fun createNtfChannelsMaybeShowAlert() {
    ...
    manager.deleteNotificationChannel("com.grayheterotopia.app.CALL_NOTIFICATION")
    manager.deleteNotificationChannel("com.grayheterotopia.app.CALL_NOTIFICATION_1")
    manager.deleteNotificationChannel("com.grayheterotopia.app.LOCK_SCREEN_CALL_NOTIFICATION")
  }
