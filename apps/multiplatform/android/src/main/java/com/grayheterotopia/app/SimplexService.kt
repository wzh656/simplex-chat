package com.grayheterotopia.app
...
import com.grayheterotopia.app.model.NtfManager
    ...
    withLongRunningApi {
      ...
      try {
        ...
        if (chatDbStatus != DBMigrationResult.OK) {
          Log.w(com.grayheterotopia.app.TAG, "GrayHeterotopiaService: problem with the database: $chatDbStatus")
...
//        }
  ...
  companion object {
    const val TAG = "GRAY_HETEROTOPIA_SERVICE"
    const val NOTIFICATION_CHANNEL_ID = "com.grayheterotopia.app.GRAY_HETEROTOPIA_SERVICE_NOTIFICATION"
    const val NOTIFICATION_CHANNEL_NAME = "Gray Heterotopia service"
    ...
    private const val SHARED_PREFS_ID = "com.grayheterotopia.app.GRAY_HETEROTOPIA_SERVICE_PREFS"
