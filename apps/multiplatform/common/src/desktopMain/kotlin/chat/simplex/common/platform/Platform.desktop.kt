...
private val unixConfigPath = (System.getenv("XDG_CONFIG_HOME") ?: "$home/.config") + "/grayheterotopia"
private val unixDataPath = (System.getenv("XDG_DATA_HOME") ?: "$home/.local/share") + "/grayheterotopia"
...
enum class DesktopPlatform(val libExtension: String, val configPath: String, val dataPath: String, val githubAssetName: String) {
  LINUX_X86_64("so", unixConfigPath, unixDataPath, "grayheterotopia-desktop-x86_64.AppImage"),
  LINUX_AARCH64("so", unixConfigPath, unixDataPath, "grayheterotopia-desktop-aarch64.AppImage"),
  WINDOWS_X86_64("dll", System.getenv("AppData") + File.separator + "GrayHeterotopia", System.getenv("AppData") + File.separator + "GrayHeterotopia", "grayheterotopia-desktop-windows-x86_64.msi"),
  MAC_X86_64("dylib", unixConfigPath, unixDataPath, "grayheterotopia-desktop-macos-x86_64.dmg"),
  MAC_AARCH64("dylib", unixConfigPath, unixDataPath, "grayheterotopia-desktop-macos-aarch64.dmg");
