...
val GrayTypography = Typography(
  displayLarge = TextStyle(fontFamily = Inter, fontWeight = FontWeight.Bold, fontSize = 34.sp, lineHeight = 40.sp),
  headlineLarge = TextStyle(fontFamily = Inter, fontWeight = FontWeight.Bold, fontSize = 28.sp, lineHeight = 34.sp),
...
internal fun grayColorScheme(colors: Colors): ColorScheme {
  ...
  return if (colors.isLight) {
    lightColorScheme(
      ...
      surface = surface,
      onSurface = onSurface,
      surfaceVariant = Color(0xFFE3E4EA),
    ...
    darkColorScheme(
      ...
      surface = surface,
      onSurface = onSurface,
      surfaceVariant = Color(0xFF42444C),
